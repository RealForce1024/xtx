...
class Excel2003StorageTest(Testing):
	...
	def test_read(self):
		s = Excel2003Storage(r"tests/data/test.xls", sheetIndex = 0)
		dat = s.read()
	...
	def test_remove(self):
		with self.assertRaises(StorageNotFoundError):
			s = Excel2003Storage(r"tests/data/test_notexists.xls", sheetIndex = 0)
			s.remove()
		s = Excel2003Storage(r"tests/data/test_todel.xls", sheetIndex = 0)
		s.create()
		s.remove()
