...
class ExcelStorageTest(Testing):
	...
	def test_create_file_not_exists(self):
		...
		s = ExcelStorage(self.tmpdir + testfile)
		s.remove(force = True)
		s.create()
		s.remove(force = True)
	...
	def test_read(self):
		s = ExcelStorage(r"tests/data/test.csv")
		dat = s.read()
	...
	def test_remove(self):
		with self.assertRaises(StorageNotFoundError):
			s = ExcelStorage(r"tests/data/test_notexists.csv")
			s.remove()
		s = ExcelStorage(r"tests/data/test_todel.csv")
		s.create()
		s.remove()
