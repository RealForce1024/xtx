...
class ExcelStorageTest(Testing):
	...
	def test_read(self):
		s = ExcelStorage(r"tests/data/test.xlsx", sheetIndex = 0)
		dat = s.read()
	...
	def test_remove(self):
		with self.assertRaises(StorageNotFoundError):
			s = ExcelStorage(r"tests/data/test_notexists.xlsx", sheetIndex = 0)
			s.remove()
		s = ExcelStorage(r"tests/data/test_todel.xlsx", sheetIndex = 0)
		s.create()
		s.remove()
