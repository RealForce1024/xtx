...
class Excel2007StorageTest(Testing):
	...
	def test_create_file_not_exists(self):
		...
		s = Excel2007Storage(self.tmpdir + testfile)
		s.remove(force = True)
		s.create()
		s.remove(force = True)
	...
	def test_read(self):
		s = Excel2007Storage(r"tests/data/test.csv")
		dat = s.read()
	...
	def test_copy_path(self):
		...
		s.remove()
		Excel2007Storage(newpath).remove()

	def test_remove(self):
		with self.assertRaises(StorageNotFoundError):
			s = Excel2007Storage(r"tests/data/test_notexists.csv")
			s.remove()
		s = Excel2007Storage(r"tests/data/test_todel.csv")
		s.create()
		s.remove()
