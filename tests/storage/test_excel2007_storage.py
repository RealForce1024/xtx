...
class Excel2007StorageTest(Testing):
	...
	def test_read(self):
		s = Excel2007Storage(r"tests/data/test.xlsx", sheetIndex = 0)
		dat = s.read()
	...
	def test_remove(self):
		with self.assertRaises(StorageNotFoundError):
			s = Excel2007Storage(r"tests/data/test_notexists.xlsx", sheetIndex = 0)
			s.remove()
		s = Excel2007Storage(r"tests/data/test_todel.xlsx", sheetIndex = 0)
		s.create()
		s.remove()
